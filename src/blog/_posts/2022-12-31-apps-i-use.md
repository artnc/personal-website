...
> Update 2023-05-16: I'm currently using macOS again at [work](/projects#duolingo) since Apple requires it for iOS development. I've managed to recreate my Linux setup well enough on macOS that it's no longer super jarring to switch between the two.
...
> Update 2024-09-18: Now that Intuit has shut down Mint, I've switched to [Monarch](https://www.monarchmoney.com/). It comes from the original developers of Mint and feels much the same.
...
> Update 2024-09-23: Welp, pacaur finally died on me. Now I use Yay.
