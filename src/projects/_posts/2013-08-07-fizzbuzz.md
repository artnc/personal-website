...
<p><button>Submit for grading!</button><a href="#" class="right">I give up. Show me a solution!</a></p>
<div class="hidden">
  <h2>Result:</h2>
  <p></p>
  <pre></pre>
...
(function() {
  ...
  $(".content a[href=#]").click(function(e) {
    ...
    if (grader.solutionShown === 0) {
      ...
      $(".content textarea").val('for (var i = 1; i < 101; ++i) print((i % 3 ? "" : "Fizz") + (i % 5 ? "" : "Buzz") || i);');
      $(this).remove();
    }
  });
}());
